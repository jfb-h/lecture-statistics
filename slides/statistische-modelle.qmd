...
- Beobachtete (Daten) und unbeobachtete (Parameter) Variablen
- Struktur und Annahmen

## Beispiel aleatorisch vs. epistemisch
...
- Eine Wahrscheinlichkeits-verteilung ordnet jedem möglichen *Ereignis* eines Zufallsprozesses eine Zahl zwischen 0 und 1 zu. 
...
animate(p, nframes = 50, fps = 10, width = 11, height = 6)
```
