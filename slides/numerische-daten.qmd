...
- Effektiv: Antworten zu Abb. / Tabelle, Zeitlimit -> Fehlerraten vergleichen
- Effizient: In Paaren, Zeit stoppen bis Maximum gefunden
- Lügen mit Karten ?
...
-   **Numerisch**: kontinuierlich, diskret (zählbar)
    - **Kontinuierlich:** Niederschlag, Einkommen, ...
    - **Diskret:** Personen in Haushalt, Tore im Fußball, ...
-   **Kategorisch**: nominal (ungeordnet), ordinal (geordnet)
    - **Nominal:** Geschlecht, Studiengang, ...
    - **Ordinal:** Bildungsabschluss, Likert-Rating, ...
